...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '{{ action("ConfirmWritherManageOtherController@datatable_clip") }}',
                method: 'POST'
            },
          columns: [
          ...
          rowCallback: function(nRow, aData, dataIndex){
            ...
            $('td:last-child',nRow).html(''
                +'<a onclick="closeClip('+aData['id']+');" class="btn btn-sm btn-warning" >ปิดตอน</a>'
                +'<a onclick="confirmClip('+aData['id']+');" class="btn btn-sm btn-success" >อนุมัติ</a>'
            );
...
if (value != null) {
   window.location.href="confirm_clip/"+id+"/close/"+value;
}
...
function confirmStory(id){
    ...
    if(confirm("ยืนยัน การอนุมัติ")){
        ...
        window.location.href="confirm_clip/"+id+"/confirm";
