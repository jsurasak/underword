...
@section('content')
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">จัดการ Report Comment Chapter</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">จัดการ Report Comment Chapter</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">จัดการ Report Comment Chapter</h4>
                        </div>
...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '{{ action("CommentReportController@datatableChapter") }}',
    			data: function ( d ) {},
                method: 'POST'
            },
          columns: [
            {title :'คอมเม้น',data:'comment', className: 'text-center', defaultContent: '-'},
            {title :'เรื่อง',data:'name', className: 'text-center', defaultContent: '-'},
