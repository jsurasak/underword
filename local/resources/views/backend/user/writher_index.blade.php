...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '{{ action("WritherController@datatable") }}',
    			data: function ( d ) {},
                method: 'POST'
            },
          columns: [
          ...
          rowCallback: function(nRow, aData, dataIndex){
            ...
            $('td:eq(0)',nRow).html('<img src="{{ url("../imgContent") }}/'+aData['writher_pic']+'" width="100px" height="100px">');
...
function create_w(){
  ...
  $('#myModal').modal();
  $('#myform').attr('action','{{ action("WritherController@add") }}');
  ...
  $.ajax('writherEdit',
    {
      ...
      success: function(data) {
        ...
        $('#pictureShow').attr('src','{{ url("../imgContent") }}/'+data[0]['writher_pic']).attr('width','250px').attr('height','250px');
      }
    });

  $('#myModal').modal();
  $('#myform').attr('action','{{ action("WritherController@edit") }}');
}
