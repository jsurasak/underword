                        ...
                        <div class="panel-body">
                          <div class="row" style="padding: 0px 2px 0 0;">
            								...
            								<div class="col-md-6 text-right" >
            									<a href="{{ action('EventController@formAdd') }}" class="btn btn-sm btn-success">Create Event</a>
            								</div>
            							</div>
            							<br>
...
$(function() {
      ...
      $('#date').datetimepicker({ format:'YYYY-MM-DD HH:mm:ss' });
          ...
          serverSide: true,
          ajax: {
    			url: '{{ action("EventController@datatable") }}',
                method: 'POST'
            },
          columns: [
          ...
          rowCallback: function(nRow, aData, dataIndex){
            ...
            $('td:eq(0)',nRow).html('<img src="{{ url("../") }}/'+aData['picture']+'" width="200px" height="200px">');
