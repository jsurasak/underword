			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">จัดการ นิยาย {{ $book->name }}</h4>
                        </div>
...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '{{ action("WritherManageNovelController@datatable_book") }}',
    			data: function ( d ) { 
                    d.id = $('#id').val();
                },
                method: 'POST'
...
function editV(d,e){
    ...
    var id = $(d).data('id');
     ...
     $.ajax('{{ action("WritherManageNovelController@updateview") }}', {
        type: 'POST',
        data: {
            'id':id,
            'view':data
...
if(confirm("ยืนยันการลบตอน")){
    ...
    $.ajax('{{ action("WritherManageNovelController@delbook") }}', {
    type: 'POST',
    data: {
        'id':id,
    },
