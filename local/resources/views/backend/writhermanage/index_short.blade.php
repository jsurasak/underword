...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '{{ action("WritherManageOtherController@datatable_short") }}',
                method: 'POST'
            },
          columns: [
          ...
          rowCallback: function(nRow, aData, dataIndex){
            ...
            $('td:last-child',nRow).html(''
                +'<a href="manage_short/'+aData['id']+'/form" class="btn btn-xs btn-success">แก้ไข</a>'
...
if (value != null) {
   window.location.href="manage_short/"+id+"/close/"+value;
}
...
function delNovel(id){
    ...
    if(confirm("ยืนยันที่จะลบข้อมูล จะไม่สามารถนำกลับมาได้อีก")){
        window.location.href="manage_short/"+id+"/del";
    }
