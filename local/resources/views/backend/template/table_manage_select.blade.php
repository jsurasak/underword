...
<head>
	<meta charset="utf-8" />
	<title>Color Admin | Managed Tables - TableTools</title>
...
<body>
						...
						<ul class="sub-menu">
							...
							<li class="has-sub active">
							    ...
							    <ul class="sub-menu">
							        ...
							        <li class="active"><a href="table_manage_select">Select</a></li>
	...
	<script src="assets/js/table-manage-select.demo.min.js"></script>
