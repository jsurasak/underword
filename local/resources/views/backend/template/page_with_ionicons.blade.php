...
<head>
	<meta charset="utf-8" />
	<title>Color Admin | Page with Ionicons</title>
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
				...
				<ul class="nav">
						...
						<ul class="sub-menu">
							...
							<li class="has-sub">
							    ...
							    <ul class="sub-menu">
							        ...
							        <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=table_manage_rowreorder">RowReorder <i class="ion-paper-airplane text-theme"></i></a></li>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							...
							<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=chart-d3">d3 Chart <i class="ion-paper-airplane text-theme"></i></a></li>
						</ul>
					</li>
					<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=calendar"><i class="ion-calendar"></i> <span>Calendar</span></a></li>
					<li class="has-sub">
					    <a href="javascript:;">
					        <b class="caret pull-right"></b>
						    <i class="ion-map"></i>
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu"><li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=page_blank">Blank Page</a></li>
							...
							<li class="active"><a href="page_with_ionicons">Page with Ionicons</a></li>
                            ...
                            <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=page_with_top_menu">Page with Top Menu <i class="ion-paper-airplane text-theme"></i></a></li>
                            <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=page_with_boxed_layout">Page with Boxed Layout <i class="ion-paper-airplane text-theme"></i></a></li>
                            <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=page_with_mixed_menu">Page with Mixed Menu <i class="ion-paper-airplane text-theme"></i></a></li>
                            <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=page_boxed_layout_with_mixed_menu">Boxed Layout with Mixed Menu <i class="ion-paper-airplane text-theme"></i></a></li>
                            <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=page_with_transparent_sidebar">Page with Transparent Sidebar <i class="ion-paper-airplane text-theme"></i></a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
					...
					<li class="has-sub">
					    ...
					    <ul class="sub-menu">
					        ...
					        <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=../template_content_angularjs/index">ANGULAR JS <i class="ion-paper-airplane text-theme"></i></a></li>
					    </ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Page with Ionicons <small>header small text goes here...</small></h1>
			<!-- end page-header -->
			
			<p>
			    Sample sidebar created with <a href="ui_ionicons">Ionicons</a>
			</p>
		</div>
		<!-- end #content -->
