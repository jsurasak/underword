				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown navbar-language">
						...
						<ul class="dropdown-menu animated fadeInRight p-b-0">
							<li class="arrow"></li>
							<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;"><span class="flag-icon flag-icon-us" title="us"></span> English</a></li>
							<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;"><span class="flag-icon flag-icon-cn" title="cn"></span> Chinese</a></li>
							<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;"><span class="flag-icon flag-icon-jp" title="jp"></span> Japanese</a></li>
							<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;"><span class="flag-icon flag-icon-be" title="be"></span> Belgium</a></li>
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							...
							<li class="active"><a href="ui_language_bar_icon">Language Bar & Icon</a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
