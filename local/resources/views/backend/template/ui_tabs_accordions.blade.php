				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							...
							<li class="active"><a href="ui_tabs_accordions">Tabs & Accordions</a></li>
			...
			<div class="row">
			    ...
			    <div class="col-md-6">
					...
					<ul class="nav nav-pills">
						...
						<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=#nav-pills-tab-2" data-toggle="tab">Pills Tab 2</a></li>
						<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=#nav-pills-tab-3" data-toggle="tab">Pills Tab 3</a></li>
						<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=#nav-pills-tab-4" data-toggle="tab">Pills Tab 4</a></li>
					</ul>
					<div class="tab-content">
