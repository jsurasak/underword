...
<head>
	<meta charset="utf-8" />
	<title>Color Admin | Managed Tables - Autofill</title>
...
<body>
						...
						<ul class="sub-menu">
							...
							<li class="has-sub active">
							    ...
							    <ul class="sub-menu">
							        ...
							        <li class="active"><a href="table_manage_autofill">Autofill</a></li>
	...
	<script src="assets/js/table-manage-autofill.demo.js"></script>
