	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
							...
							<li class="active"><a href="map_google">Google Map</a></li>
						</ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
		...
		<div id="content" class="content content-full-width">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;">Map</a></li>
            ...
            <div class="map-content">
                <div class="btn-group map-btn pull-right">
                    ...
                    <ul class="dropdown-menu" id="map-theme-selection">
                        ...
                        <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;" data-map-theme="flat">Flat</a></li>
                        <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;" data-map-theme="turquoise-water">Turquoise Water</a></li>
                        <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;" data-map-theme="icy-blue">Icy Blue</a></li>
                        <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;" data-map-theme="cobalt">Cobalt</a></li>
                        <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;" data-map-theme="old-dry-mud">Old Dry Mud</a></li>
                        <li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;" data-map-theme="dark-red">Dark Red</a></li>
                    </ul>
                </div>
            </div>
			<div class="map">
