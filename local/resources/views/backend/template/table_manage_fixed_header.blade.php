...
<head>
	<meta charset="utf-8" />
	<title>Color Admin | Managed Tables - Fixed Header</title>
...
<body>
						...
						<ul class="sub-menu">
							...
							<li class="has-sub active">
							    ...
							    <ul class="sub-menu">
							        ...
							        <li class="active"><a href="table_manage_fixed_header">Fixed Header</a></li>
	...
	<script src="assets/js/table-manage-fixed-header.demo.min.js"></script>
