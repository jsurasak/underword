...
<head>
	<meta charset="utf-8" />
	<title>Color Admin | Morris Chart</title>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
						    ...
						    <li class="active"><a href="chart-morris">Morris Chart</a></li>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="{{asset(Config::get('app.admin_path'))}}/template/?file=javascript:;">Chart</a></li>
