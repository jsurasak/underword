...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("CategoryController@datatable1")); ?>',
    			data: function ( d ) {},
                method: 'POST'
            },
          columns: [
    ...
    oTable2 = $('#data-table2').DataTable({
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("CategoryController@datatable2")); ?>',
    			data: function ( d ) {},
                method: 'POST'
            },
          columns: [
...
function edit(id){
        ...
        $.ajax('<?php echo e(action("CategoryController@edit_select")); ?>', {
        type: 'POST',
        data: {
            'id':id
        },
...
function submit(){
    ...
    $.ajax('<?php echo e(action("CategoryController@update")); ?>', {
        type: 'POST',
...
function del(id){
	...
	function(){
       ...
       $.ajax('<?php echo e(action("CategoryController@delete")); ?>', {
        type: 'POST',
        data:{'id':id },
        dataType: 'json',
        success: function(data) {
