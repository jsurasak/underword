<?php $__env->startSection('content'); ?>
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active"><?php echo e($name->name_content); ?></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
            								...
            								<div class="col-md-6 text-left" >
            									<div class="pull-left w210">
																<select class="form-control" onchange="selectD(this);">
																	<option value="Sun" <?php echo e(((date('D')== "Sun")?'selected':'')); ?>>วันอาทิตย์</option>
																	<option value="Mon" <?php echo e(((date('D')== "Mon")?'selected':'')); ?>>วันจันทร์</option>
																	<option value="Tue" <?php echo e(((date('D')== "Tue")?'selected':'')); ?>>วันอังคาร</option>
																	<option value="Wed" <?php echo e(((date('D')== "Wed")?'selected':'')); ?>>วันพุธ</option>
																	<option value="Thu" <?php echo e(((date('D')== "Thu")?'selected':'')); ?>>วันพฤหัสบดี</option>
																	<option value="Fri" <?php echo e(((date('D')== "Fri")?'selected':'')); ?>>วันศุกร์</option>
																	<option value="Sat" <?php echo e(((date('D')== "Sat")?'selected':'')); ?>>วันเสาร์</option>
																</select>
            									</div>
            								</div>
            								<div class="col-md-6 text-right" >
            									<a href="<?php echo e(action('ContentController@FormAdd',$id)); ?>" class="btn btn-sm btn-success">Create Content</a>
            								</div>
            							</div>
            							<br>
                          <table id="data-table" class="table table-striped table-bordered"></table>
												...
												<form>
													<input type="hidden" id="tContent" name="tContent" value="<?php echo e($id); ?>">
													<input type="hidden" id="dContent" name="dContent" value="<?php echo e(date('D')); ?>">
												</form>
                    </div>
                    <!-- end panel -->
                </div>
...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("ContentController@datatable")); ?>',
    			data: function ( d ) {
	          ...
	          rowCallback: function(nRow, aData, dataIndex){
	            ...
	            $('td:eq(0)',nRow).html('<img src="<?php echo e(url("../imgContent")); ?>/'+aData['pic_A']+'" width="150px" height="100px">');
	            $('td:eq(1)',nRow).html('<img src="<?php echo e(url("../imgContent")); ?>/'+aData['pic_B']+'" width="100px" height="100px">');
...
function review(id){
  ...
  $('.modal-body').css('height', '1000px');
	$('#review_iframe').html("<iframe src='<?php echo e(url('../')); ?>/inside-content/"+id+"/' width='100%' height='100%'></ifram>");
