        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="myform" class="form-horizontal" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" id="type" name="type" value="<?php echo e($id); ?>" >
...
$(function() {
      ...
      $('#date').datetimepicker({ format:'YYYY-MM-DD HH:mm:ss' });
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("ContentController@datatable_comice")); ?>',
    			data: function ( d ) {
          ...
          rowCallback: function(nRow, aData, dataIndex){
            ...
            $('td:eq(0)',nRow).html('<img src="<?php echo e(url("../imgContent")); ?>/'+aData['picture']+'" width="200px" height="200px">');
    ...
    $.ajax('modalC',
      {
        ...
        success: function(data) {
          ...
          $('#pictureShow').attr('src','<?php echo e(url("../imgContent")); ?>/'+data[0]['picture']);
        }
      });
    $('#myModal').modal();
