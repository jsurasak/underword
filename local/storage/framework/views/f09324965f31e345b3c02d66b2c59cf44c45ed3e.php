...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("WritherManageOtherController@datatable_clip")); ?>',
                method: 'POST'
            },
          columns: [
...
function review(id){
	...
	$('#review_iframe').html("<iframe src='<?php echo e(url('../')); ?>/review-clip/"+id+"/' width='100%' height='100%'></ifram>");
