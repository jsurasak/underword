        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form id="sellDate" >
                    ...
                    <div class="form-group">
                        <label >รอบบิล</label>
                        <input type="number" name="round" value="<?php echo e($round); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label >ปี ของรอบบิล</label>
                        <input type="text" name="year" placeholder="20xx" value="<?php echo e(date('Y')); ?>" class="form-control">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
$(function() {
        ...
        $('#dateBile').datepicker({
          ...
          order:[ 2, 'asc' ],
          ajax: {
    			url: '<?php echo e(action("ReportSellController@datatableUser")); ?>',
    			data: function ( d ) {
                    d.round = $('#round').val();
                    d.year = $('#year').val();
                    d.type = $('#type').val();
...
function sellDateSell(){
    ...
    if(confirm("ยันยันการชำระเงิน")){
        ...
        $.ajax('<?php echo e(action("ReportSellController@update")); ?>',{
            type:'POST',
...
function detail(id){
    ...
    $.ajax('<?php echo e(action("ReportSellController@detailReport")); ?>',{
        type:'POST',
        data:{
            id:id
        },
