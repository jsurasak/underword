...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("RequirementsController@datatable")); ?>',
                method: 'POST'
            },
          columns: [
          ...
          rowCallback: function(nRow, aData, dataIndex){
            ...
            var picture = '<img src ="<?php echo e(url("../")); ?>/'+aData['img']+'" width="200" heigth="250px" >';
            ...
            $('td:eq(0)',nRow).html(picture);
             ...
             $('td:last-child',nRow).html(''
                +'<a href="<?php echo e(action("RequirementsController@index")); ?>/'+aData['id']+'/form" class="btn btn-sm btn-success">แก้ไข</a>'   
            );
