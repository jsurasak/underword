                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                          <div class="row" style="padding: 0px 2px 0 0;">
                            ...
                            <br>
                            <form id="myform" action="<?php echo e(action('RequirementsController@update')); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <label class="control-label col-sm-3" >Heade</label>
                              <div class="col-sm-8">
                                <input type="text" class="form-control" name="header" readonly  value="<?php echo e($data->head); ?>">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 text-center">
                                  ...
                                  <a href="<?php echo e(action('RequirementsController@index')); ?>" type="button" class="btn btn-default" >Back</a>
                                </div>
                              </div>
                            </form>
