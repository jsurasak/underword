		  ...
		  <div class="modal-dialog modal-lg" >
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body" style="height: 100%;">
                <form id="myform" method="POST" action="<?php echo e(action('GhostgiftController@update')); ?>" enctype="multipart/form-data">
...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("GhostgiftController@datatable")); ?>',
    			data: function ( d ) {},
                method: 'POST'
            },
          columns: [
...
function editPic(data,id){
    ...
    $('#pic_show').attr('src','<?php echo e(url("../")); ?>' + picture);
    $('#id').val(id);
    $('#oldPic').val(picture);
    $('#name').val(name);
    $('#detail').val(detail);
