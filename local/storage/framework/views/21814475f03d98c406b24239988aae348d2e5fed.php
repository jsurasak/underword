                        ...
                        <div class="panel-body">
                          <div class="row" style="padding: 0px 2px 0 0;">
            								...
            								<div class="col-md-6 text-right" >
            									<a href="<?php echo e(action('UserController@addForm')); ?>" class="btn btn-sm btn-success">Create User</a>
            								</div>
            							</div>
            							<br>
...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("UserController@datatable")); ?>',
    			data: function ( d ) {},
                method: 'POST'
            },
          columns: [
...
function updateVIP(id){
	...
	function(){
        ...
        $.ajax('<?php echo e(action("UserController@update_vip")); ?>', {
        type: 'POST',
        data: {
            'id':id
        },
...
function add_s(id){
    ...
    if (point != null) {
    $.ajax('<?php echo e(action("UserController@update_pointS")); ?>', {
        type: 'POST',
        data: {
            id:id,
            point:point
...
function add_b(id){
    ...
    if (point != null) {
    $.ajax('<?php echo e(action("UserController@update_pointB")); ?>', {
        type: 'POST',
        data: {
            id:id,
            point:point
