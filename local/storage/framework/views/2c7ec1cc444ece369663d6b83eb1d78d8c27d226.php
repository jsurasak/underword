		<div id="header" class="header navbar navbar-inverse navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a href="<?php echo e(url('')); ?>/home" class="navbar-brand"><span class="navbar-logo"></span>Backoffice</a>
				...
				<ul class="nav navbar-nav navbar-right">
					<!--<?php echo $__env->make('backend.inc.notifications', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>-->
