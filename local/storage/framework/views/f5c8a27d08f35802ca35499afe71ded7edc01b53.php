...
$(function() {
          ...
          order:[ 0 ,'desc'],
          ajax: {
    			url: '<?php echo e(action("WritherManageNovelController@datatable_bookvip")); ?>',
    			data: function ( d ) {},
                method: 'POST'
            },
          columns: [
          ...
          rowCallback: function(nRow, aData, dataIndex){
            ...
            $('td:eq(2)',nRow).html(''
                +'<img src ="<?php echo e(url("../")); ?>/'+aData['pic_B']+'" width="100px">'                    
            );
...
function Check(type){
  ...
  if(count > 5){
    ...
    oTable.draw();
     ...
     $.ajax('<?php echo e(action("WritherManageNovelController@top_vipnove")); ?>', {
         type: 'POST',
         data:myform,
         dataType: 'json',
