			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form id="myForm1" action="<?php echo e(action('AboutusController@updatedetail')); ?>" method="POST">
                            <?php echo e(csrf_field()); ?>

                            <input type="hidden" name="id" value="1">
                            <textarea class="ckeditor" name="detail" id="detail1" rows="10"><?php echo e($detail->detail); ?></textarea>
                            </form>
                            <br>
			...
			<div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form id="myForm3" action="<?php echo e(action('AboutusController@updatedetail')); ?>" method="POST">
                            <?php echo e(csrf_field()); ?>

                            <input type="hidden" name="id" value="2">
                            <textarea class="ckeditor" name="detail" id="detail2" rows="10"><?php echo e($ad->detail); ?></textarea>
                            </form>
                            <br>
                            <div class="row" style="padding: 0px 2px 0 0;">
                            <div class="col-md-6 text-left" >
...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("AboutusController@datatable")); ?>',
                method: 'POST'
            },
          columns: [
...
function edit(id){
        ...
        $.ajax('<?php echo e(action("AboutusController@editquestion")); ?>', {
        type: 'POST',
        data: {
            'id':id
        },
...
function submit(){
    ...
    $.ajax('<?php echo e(action("AboutusController@addquestion")); ?>', {
        type: 'POST',
...
function del(id){
    ...
    if(confirm('ยืนยันการลบข้อมูล')){
        ...
        $.ajax('<?php echo e(action("AboutusController@delete")); ?>', {
        type: 'POST',
        data:{'id':id },
        dataType: 'html',
        success: function(data) {
