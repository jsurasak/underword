                        ...
                        <div class="panel-body">
                          <div class="row" style="padding: 0px 2px 0 0;">
                                ...
                                <div class="col-md-12 text-right" >
                                    ...
                                    <a href="<?php echo e(action('LinetodayController@update')); ?>" class="btn btn-sm btn-success"><?php if($dateL->created == date('Y-m-d')): ?>Lastupdate Now <?php else: ?> Lastupdate <?php echo e($dateL->created); ?><?php endif; ?></a>
                                </div>
                            </div>
            				<br>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body" style="height: 100%;">
                    <div class="form-group">
                        ...
                        <option value="<?php echo e($t->id); ?>"><?php echo e($t->name_content); ?></option>
...
$(function() {
          ...
          serverSide: true,
          ajax: {
    			url: '<?php echo e(action("LinetodayController@datatable")); ?>',
                method: 'POST'
            },
						columns: [
    ...
    $('#typeContent').change(function(){
        ...
        $.ajax({
            url:'<?php echo e(action("LinetodayController@selectContenr")); ?>',
            method:'POST',
            data:{
...
function addContent(){
    ...
    if(id){
        ...
        $.ajax({
            url:'<?php echo e(action("LinetodayController@addContenr")); ?>',
            method:'post',
            data:{
                type:type,
                id:id
...
function del(id){
	...
	function(){
        ...
        $.ajax({
            url:'<?php echo e(action("LinetodayController@delContenr")); ?>',
            method:'POST',
            data:{
                id:id
            },
