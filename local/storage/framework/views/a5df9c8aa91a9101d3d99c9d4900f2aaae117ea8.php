...
<head>
	...
	<link rel="icon" href="<?php echo e(url('../')); ?>/img/favicon.png" sizes="32x32">
...
<body>
	...
	<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
		<!-- begin #header -->
		<?php echo $__env->make('backend.inc.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<!-- end #header -->

		<!-- begin #sidebar -->
		<?php echo $__env->make('backend.inc.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<!-- <?php echo $__env->make('backend.inc.theme-panel', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
		...
		<!-- begin #footer -->
		<?php echo $__env->make('backend.inc.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<!-- end #footer -->
			...
			<div class="modal-content" style="margin-top: 15%;">
				...
				<div class="modal-body">
					<div class="alert alert-success m-b-0">
						...
						<div><b id="status"><?php echo e(ucfirst(session('alert.status'))); ?>,</b> <span id="msg"><?php echo e(session('alert.msg')); ?></span></div>
					</div>
				</div>
